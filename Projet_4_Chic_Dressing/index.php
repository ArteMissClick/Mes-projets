...
<title>Chic Dressing - Des marques de luxes à prix cassés</title>

<meta name="description" content="Chic Dressing est un site d'achat-vente pour des marques de luxe en ligne ! Venez découvrir quelles pièces de créateurs sont proposés, à des prix cassés plus qu'abordable." />
...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Dernières pièces de créateurs à prix cassés</h2>
		<?php
		echo do_shortcode('[products orderby="date" columns="3" order="ASC"]');
		?>
		<p class="text-center"><a class="chic-bouton" href="/Chic-Dressing-2/shop">Voir toute la collection</a></p>
	</div>
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">La FashionMap - Le luxe de l'été 2022 </h2>
		<iframe title="Google Maps" src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480"></iframe>';
	</div>
	<?php
